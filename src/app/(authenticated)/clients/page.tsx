          ...
          {filteredClients.map((client) => (
            <div key={client.id} className="group relative rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-gax-blue/30 hover:shadow-md">
              <button 
                ...
                className="absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-full bg-slate-50 text-slate-400 opacity-0 transition-all hover:bg-gax-blue-light hover:text-gax-blue group-hover:opacity-100"
          ...
          <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              <div className="space-y-1">
                ...
                <div className="rounded-xl border border-slate-100 bg-slate-50 px-4 py-2.5 text-xs font-medium text-slate-500">
                  {editingClient?.name}
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <input 
                  ...
                  className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-xs outline-none focus:border-gax-blue focus:ring-4 focus:ring-gax-blue/10"
                  placeholder="00.000.000/0000-00"
                />
              </div>

              <div className="space-y-1">
                <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Registro ANS</label>
                <input 
                  type="text" 
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold uppercase tracking-wider text-slate-400">Endereço Completo</label>
                <textarea 
                  value={formData.endereco}
                  onChange={(e) => setFormData({...formData, endereco: e.target.value})}
                  className="w-full min-h-[80px] rounded-xl border border-slate-200 px-4 py-2.5 text-xs outline-none focus:border-gax-blue focus:ring-4 focus:ring-gax-blue/10"
