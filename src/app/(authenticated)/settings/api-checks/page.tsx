...
export default function ApiChecksPage() {
  ...
  const totalCount = activeTask?.total_clients || activeTask?.total || 1;
  const currentCount = activeTask?.processed_count || activeTask?.current || 0;
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 flex items-center gap-1.5 mt-0.5 font-medium">
                      Atual: <span className="text-indigo-600 font-bold">{activeTask.current_client ? `Checando ${activeTask.current_client}...` : 'Iniciando...'}</span>
                    </p>
                  </div>
                </div>
